...
Las métricas recopiladas con perf stat muestran una caída sostenida del rendimiento a medida que crece el tamaño de la matriz, pasando de 5.53 GFLOPS para $N=128$ hasta 3.05 GFLOPS para $N=1024$.
