...
\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/charts/time_seq_vs_mpi_noopt.png}
   \caption{Tiempo de ejecución de la implementación con MPI}
\end{figure}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/charts/time_seq_vs_mpi_opt.png}
   \caption{Tiempo de ejecución de la implementación con MPI con optimizaciones}
\end{figure}
